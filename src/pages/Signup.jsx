...
export default function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    // Basic password checking before wasting an API call
    ...
    try {
      // TODO: Replace this URL when the backend team provides their live server URL
      ...
      // Automatically redirect the new user to login page on success
      navigate('/login');
